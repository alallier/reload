...
| forceWss                 | boolean | Forces reload client connections to always use `wss` (secure websockets) even when the window location is HTTP                                                                                                                                                                                                                                                                                             | ✓        | FALSE   |
...
Options:
  ...
  -i, --ignore [ignore]          Directories/files to ignore as a comma delimited list, glob supported. Default none
